...
x_conv1_b1 = Conv3D(filters=c, kernel_size=(1,3,3), padding='same', activation="relu")(x0)
x_conv2_b1 = Conv3D(filters=c, kernel_size=(1,3,3), padding='same', activation="relu")(x_conv1_b1)
x_max_b1 = MaxPool3D([1, 2, 2],padding='same')(x_conv2_b1)
x_bn_b1 = BatchNormalization()(x_max_b1)
x_do_b1 = Dropout(dropout_rate)(x_bn_b1)

x_conv1_b2 = Conv3D(filters=2*c, kernel_size=(1,3,3), padding='same', activation="relu")(x_do_b1)
x_conv2_b2 = Conv3D(filters=2*c, kernel_size=(1,3,3), padding='same', activation="relu")(x_conv1_b2)
x_max_b2 = MaxPool3D([1, 2, 2],padding='same')(x_conv2_b2)
x_bn_b2 = BatchNormalization()(x_max_b2)
x_do_b2 = Dropout(dropout_rate)(x_bn_b2)

x_conv1_b3 = Conv3D(filters=4*c, kernel_size=(1,3,3), padding='same', activation="relu")(x_do_b2)
x_conv2_b3 = Conv3D(filters=4*c, kernel_size=(1,3,3), padding='same', activation="relu")(x_conv1_b3)
x_max_b3 = MaxPool3D([1, 2, 2],padding='same')(x_conv2_b3)
x_bn_b3 = BatchNormalization()(x_max_b3)
x_do_b3 = Dropout(dropout_rate)(x_bn_b3)

x_conv1_b4 = Conv3D(filters=8*c, kernel_size=(1,3,3), padding='same', activation="relu")(x_do_b3)
x_conv2_b4 =Conv3D(filters=8*c, kernel_size=(1,3,3), padding='same', activation="relu")(x_conv1_b4)
...
x_conv1_b5 = Conv3D(filters=8*c, kernel_size=(1,3,3), padding='same', activation="relu")(x_do_b4)
x_conv2_b5 =Conv3D(filters=8*c, kernel_size=(1,3,3), padding='same', activation="relu")(x_conv1_b5)
x_deconv_b5 = Conv3DTranspose(filters=8*c, kernel_size=(1, 2, 2),strides=(1,2,2),padding='same', activation="relu")(x_conv2_b5)
...
x_conv1_b6 = Conv3D(filters=4*c, kernel_size=(2,1,1), activation="relu")(layers.concatenate([cropped_x_conv2_b4,x_do_b5]))
x_conv2_b6 = Conv3D(filters=4*c, kernel_size=(1, 1, 1),padding='same', activation="relu")(x_conv1_b6)
x_deconv_b6 = Conv3DTranspose(filters=4*c,  kernel_size=(1, 2, 2),strides = (1,2,2),padding='same', activation="relu")(x_conv2_b6)
...
x_conv1_b7 =Conv3D(filters=2*c, kernel_size=(2,1,1), activation="relu")(layers.concatenate([cropped_x_conv2_b3,x_do_b6]))
x_conv2_b7 = Conv3D(filters=2*c, kernel_size=(1, 1, 1),padding='same', activation="relu")(x_conv1_b7)
x_deconv_b7 =  Conv3DTranspose(filters=2*c,  kernel_size=(1, 2, 2),strides = (1,2,2),padding='same', activation="relu")(x_conv2_b7)
...
x_conv1_b8 = Conv3D(filters=1*c, kernel_size=(2,1,1), activation="relu")(layers.concatenate([cropped_x_conv2_b2,x_do_b7]))
x_conv2_b8 = Conv3D(filters=1*c, kernel_size=(1, 1, 1),padding='same', activation="relu")(x_conv1_b8)
x_deconv_b8 = Conv3DTranspose(filters=2*c,  kernel_size=(1, 2, 2),strides = (1,2,2),padding='same', activation="relu")(x_conv2_b8)
...
x_conv1_b9 =Conv3D(filters=0.5*c, kernel_size=(2,1,1), activation="relu")(layers.concatenate([cropped_x_conv2_b1,x_do_b8]))
x_conv2_b9 = Conv3D(filters=0.5*c, kernel_size=(1, 1, 1),padding='same', activation="relu")(x_conv1_b9)
